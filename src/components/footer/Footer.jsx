                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-20 items-center">
                        ...
                        <div className='md:col-span-2'>
                            ...
                            <div className="butttons flex gap-5 md:gap-16 mt-10">
                                <button className='flex items-center gap-3 p-2 bg-[#FFA301] text-white rounded-xl hover:bg-gradient-to-tr from-primary to-secondary duration-300 group'><span className='group-hover:text-primary text-white p-1 rounded-full group-hover:bg-white bg-primary text-2xl'><RxAvatar /></span><span>Dashboard Login</span></button>
                                <button className='flex items-center gap-3 p-2 bg-[#FFA301] text-white rounded-xl hover:bg-gradient-to-tr from-primary to-secondary duration-300 group'><span className='group-hover:text-primary text-white p-1 rounded-full group-hover:bg-white bg-primary text-2xl'><RxAvatar /></span><span>Dashboard Login</span></button>
                                <button className='flex items-center gap-3 p-2 bg-[#FFA301] text-white rounded-xl hover:bg-gradient-to-tr from-primary to-secondary duration-300 group'><span className='group-hover:text-primary text-white p-1 rounded-full group-hover:bg-white bg-primary text-2xl'><RxAvatar /></span><span>Dashboard Login</span></button>
                            </div>
                        </div>
