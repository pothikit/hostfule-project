                            ...
                            <div className='max-w-[1100px] mx-auto bg-white rounded-xl sm:-mt-28 px-1 md:px-0'>
                                <div className='px-2 mt-5 sm:px-8 border pb-24 pt-10 rounded-md' style={{ boxShadow: "5px 5px 30px 5px #eee" }}>
                                    <div>
                                        <div className='bg-white sm:p-6'>
                                            <Slider min={1} max={6} step={1} duration={1000} value={rangevalue} onChange={handleChange} className='cursor-pointer' />
                                            <div className='flex justify-between items-center text-black font-semibold'>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 1GB</h2>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 2GB</h2>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 4GB</h2>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 8GB</h2>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 16GB</h2>
                                                <h2 className=''><span className='hidden md:inline'>RAM</span> 32GB</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div className='border rounded-md mt-20 p-2 sm:p-6 bg-slate-100 bg-red bg-opacity-80 grid grid-cols-1 lg:grid-cols-3 gap-7'>
                                        <div className='lg:col-span-2'>
                                            ...
                                            <div className='py-7 grid grid-cols-1 md:grid-cols-2 gap-4 text-lg text-black'>
                                        ...
                                        <div>
                                            <div className='px-8 py-3 border rounded-md shadow-md bg-white'>
                                                ...
                                                <div className='border-b md-4 text-center py-8'>
                                                    <h1 className='text-xl md:text-2xl lg:text-3xl font-bold'><span className=''>Price</span> <span>{rangeData?.price}</span><br />
                                                        <span className='text-sm md:text-base font-medium'>/ Monthly</span>
                                                    </h1>
                                                    <a href={rangeData?.action_link} className='bg-green-500 hover:bg-green-700 block text-white px-3 py-1 md:py-2 text-lg md:px-7 mt-5 rounded-md'>Order Now</a>
                                                </div>
                                                <div className='mt-4'>
                                                    <h3 className='font-medium'>Select OS from Next Page</h3>
                                ...
                                <div className="rounded-md min-w-full overflow-x-auto border mt-20">
                                    <table className='w-full bg-even-slate-200 divide-y'>
                                        <thead>
                                            <tr className='w-full rounded-md bg-slate-500 text-white'>
                                                <th className='px-2 text-center py-2 text-sm md:text-lg'>Plan Name</th>
                                                <th className='px-2 text-center border-x py-2 text-sm md:text-lg'>Core / Thread</th>
                                                <th className='px-2 text-center border-x py-2 text-sm md:text-lg'>Storage</th>
                                                <th className='px-2 text-center border-x py-2 text-sm md:text-lg'>IP</th>
                                                <th className='px-2 text-center border-x py-2 text-sm md:text-lg'>Bandwidth</th>
                                                <th className='px-2 text-center border-x py-2 text-sm md:text-lg'>Price</th>
                                                <th className='px-2 text-center py-2 text-sm md:text-lg'>Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {
                                                tabelData?.map((items, idx) => (
                                                    <tr key={idx} className='even:bg-slate-200 even:bg-opacity-70'>
                                                        <td className='px-2 text-center py-3 text-sm md:text-base '>{items?.plan_name}</td>
                                                        <td className='px-2 text-center border-x py-3 text-sm md:text-base whitespace-nowrap'>{items?.core}</td>
                                                        <td className='px-2 text-center border-x py-3 text-sm md:text-base whitespace-nowrap'>{items?.storage}</td>
                                                        <td className='px-2 text-center border-x py-3 text-sm md:text-base whitespace-nowrap'>{items?.ip}</td>
                                                        <td className='px-2 text-center border-x py-3 text-sm md:text-base whitespace-nowrap'>{items?.bandwidth}</td>
                                                        <td className='px-2 text-center border-x py-3 text-sm md:text-base whitespace-nowrap'>{items?.price}</td>
                                                        <td className='px-2 text-center p-2'><a href={items?.action_link} className='bg-green-500 py-2 md:px-4 text-sm md:text-base px-2 max-w-full whitespace-nowrap text-white rounded-md hover:bg-green-700 duration-200'>Order now</a></td>
                                                    </tr>
                                                ))
                                            }
                                        </tbody>
                                ...
                                <div className='mt-32 border px-7 py-14 rounded-md shadow-lg'>
                                    <div className=''>
                                        <h1 className='font-bold text-xl sm:text-2xl mb-12 md:text-3xl lg:text-4xl text-slate-700 text-center'>supported operating systems</h1>
