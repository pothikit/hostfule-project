...
import "./header.css"
import { FaPhoneVolume, FaEnvelope, FaWhatsapp } from "react-icons/fa";
            ...
            <div className="top-header py-2">
                <div className="container mx-auto">
                    <ul className='flex justify-end items-center gap-12 text-white text-lg'>
                        <li className=''><a href="https://wa.me/+8801719375526" className='flex items-center gap-4'><span className="rotate-[270deg]"><FaWhatsapp /></span>+880 1719-375526</a></li>
