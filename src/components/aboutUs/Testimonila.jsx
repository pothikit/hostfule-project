...
export default function Testimonial() {
    ...
    return (
        <section className="py-20 testimonial">
            <div className="container mx-auto text-center px-10 sm:px-8 testimonial-container">
                ...
                <div className="mt-5">
                    <Slider {...settings}>
                        <div>
                            <div className="mx-3 sm:mx-5 py-10 sm:py-16 px-5 rounded-2xl shadow-2xl carousel-div sm:h-[480px] h-[350px]">
                                ...
                                <h3 className="text-lg md:text-2xl mt-2 sm:mt-10 font-medium">Mohsin Alam</h3>
                        ...
                        <div>
                            <div className="mx-3 sm:mx-5 py-10 sm:py-16 px-5 rounded-2xl shadow-2xl carousel-div sm:h-[480px] h-[350px]">
                                ...
                                <h3 className="text-lg md:text-2xl mt-2 sm:mt-10 font-medium">MD Tarik Eamin</h3>
                        ...
                        <div>
                            <div className="mx-3 sm:mx-5 py-10 sm:py-16 px-5 rounded-2xl shadow-2xl carousel-div sm:h-[480px] h-[350px]">
                                ...
                                <h3 className="text-lg md:text-2xl mt-2 sm:mt-10 font-medium">Abdullah Al Fouad imran</h3>
                        ...
                        <div>
                            <div className="mx-3 sm:mx-5 py-10 sm:py-16 px-3 rounded-2xl shadow-2xl carousel-div sm:h-[480px] h-[350px]">
                                <div className="-mt-28 slider-imgDiv bg-white w-24 h-24 flex items-center mx-auto rounded-full">
                                    <img src={saidulhasan} alt="" className="mx-auto w-20 h-20 z-10 shadow-2xl rounded-full" />
                                </div>
                                <h3 className="text-lg md:text-2xl mt-2 sm:mt-10 font-medium">Saidul Hasan</h3>
