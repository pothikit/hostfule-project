        ...
        <main>
            <section className='bg-slate-200'>
                <div className="container mx-auto">
                    <PageBanner animationfile={aboutAnimation} animationHeight="h-[400px]" animationPadding={"p-2 lg:p-10"} pageTitle={["About ", <span key={1} className='text-primary'>H</span>, "ostFlu ", <br className='hidden md:block'></br>, "Web Services"]}></PageBanner>
                </div>
            </section>
