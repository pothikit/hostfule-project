...
function IndividualServices(props) {
    ...
    return (
        <div className='ietms-center flex justify-center gap-5 gap-y-10 hover:shadow-xl duration-200 rounded-xl border relative p-3 pt-8 sm:p-8 hover:border-transparent'>
